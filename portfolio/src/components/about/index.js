    ...
    return (
        <div id="about">
            ...
            <div id="intro">
                ...
                <p>
                My time with both Universities has taught me much, and has given me the opportunity to develop full stack applications both independently and collabaratively. As a recent graduate, I'm eager to apply my skillsets and prove myself a valuable member in a development team.
                </p>
            </div>
        </div>
    );
